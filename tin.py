...
with st.sidebar:
    ...
    st.info("Select a date range to fetch data and predict future tin prices.")
    ...
    if prediction_period == "1-6 Months":
        prediction_days = st.slider("Select number of months for prediction", 1, 6, 3) * 30
    elif prediction_period == "3 Months":
        prediction_days = 3 * 30
    else:  # Custom
